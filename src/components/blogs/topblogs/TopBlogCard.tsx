      ...
      >
        <div className="relative group w-full h-full bg-gradient-to-t from-black/50 to-black/5 flex flex-col justify-end">
          <div className=" text-white p-5 ">
            <div className="hidden absolute h-full w-full top-0 left-0 bg-color-primaryBlack/30 md:flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out">
